...
export const Loginform = () => {
  return (
    <div className=" bg-gray-100 flex h-screen">
      ...
      <div className="h-100 flex-grow bg-gray-100 flex justify-center items-center">

        {/* Form box */}
        <div className="shadow-lg inline-block rounded-lg bg-white p-8">
        <div>
            <img src={logo} style={{ width: 100 }} className="mb-8" />
        </div>
        <div>
      ...
      <div className=" bg-blue-500 h-100 rounded-tr-xl rounded-br-xl bg-gradient-to-b from-[#199afa] to-[#0bd5e5]">
        <div className="ml-14 text-white leading-7 ">
          ...
          <div>
            <img src={map} style={{ width: 450 }} className="pb-9" />
          </div>
          <div>
